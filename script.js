...
function display(n) {
  ...
  s1.style = 'background: #E50000; color: #FFF;';
  s2.style = 'background: #E50000; color: #FFF;';
  s3.style = 'background: #E50000; color: #FFF;';
  s4.style = 'background: #E50000; color: #FFF;';

  if (n == 1) {
    img1.style = 'display: block;';
    s1.style = 'background: #E5E8EF; color: #E50000;';
  }
  if (n == 2) {
    img2.style = 'display: block;';
    s2.style = 'background: #E5E8EF; color: #E50000;';
  }
  if (n == 3) {
    img3.style = 'display: block;';
    s3.style = 'background: #E5E8EF; color: #E50000;';
  }
  if (n == 4) {
    img4.style = 'display: block;';
    s4.style = 'background: #E5E8EF; color: #E50000;';
  }
}
...
// TimeRanges
var deadline = new Date("Dec 15, 2021 14:41:25").getTime();
...
var x = setInterval(function () {
  ...
  if (t < 0) {
    alert("Click on start test ")
    clearInterval(x);
    document.getElementById("demo").innerHTML = "<a href='subjects/quiz.html'>Start Test</a>";
